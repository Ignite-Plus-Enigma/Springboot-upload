...
//	private Resource serviceAccountKey;
	...
	public void createFile(HttpServletResponse response) throws Exception {
		...
		Drive drive = new Drive.Builder(HTTP_TRANSPORT, JSON_FACTORY, cred)
				.setApplicationName("Enigma").build();

		File file = new File();
		file.setName("NewFile.jpg");

		FileContent content = new FileContent("image/jpeg", new java.io.File("C:\\Users\\Yashika.Yashu-lappy\\Pictures\\ebook.jpg"));
